...
<div class="flex flex-col">
    <h2 class="font-bold text-skin-muted text-xs uppercase tracking-wider"><?= lang('Plugin.metadata.install') ?></h2>
    ...
    <p class="mt-1 text-skin-muted text-sm"><?= lang('Plugin.metadata.compatibility', [
        'castopodVersion' => '<strong>Castopod v' . $plugin->selected_version->min_castopod_version . '</strong>',
    ]) ?></p>
</div>
...
<div class="flex flex-col items-start mt-6">
    ...
    <a class="mt-2 btn-secondary" href="<?= route_to(
        ...
        'edit-fill',
    ) ?><?= lang('Plugin.metadata.editRepository') ?></a>
    <?php endif; ?>
</div>
...
<h2 class="sr-only"><?= lang('Plugin.metadata.title') ?></h2>
...
<dl class="gap-y-6 grid grid-cols-2">
    ...
    <div class="col-span-2">
        ...
        ) ?><?= lang('Plugin.metadata.totalDownloads') ?></dt>
    ...
    <div class="col-span-2">
        ...
        <dd>
            ...
            <a class="mt-2 btn-secondary" href="<?= route_to(
                ...
                'edit-fill',
            ) ?><?= lang('Plugin.metadata.editMaintainers') ?></a>
            <?php endif; ?>
        </dd>
    </div>
</dl>
