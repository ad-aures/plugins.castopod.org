...
<head>
    <meta charset="UTF-8">
    <title>The Castopod Plugin Hub</title>
...
<body class="flex flex-col bg-[length:300px] bg-brand-800" style="background-image: url('<?= base_url(
        ...
        <nav class="flex justify-between items-center starting:opacity-0 border-b border-brand-950 h-20 transition starting:-translate-y-full duration-500 ease-out container">
            <div class="flex items-center gap-8">
                ...
                <div class="flex items-center gap-2">
                    <a href="https://blog.castopod.org/" class="px-4 py-2 font-semibold decoration-2 decoration-brand-500 hover:underline">Blog</a>
                    <a href="https://docs.castopod.org/" class="px-4 py-2 font-semibold decoration-2 decoration-brand-500 hover:underline">Docs</a>
                </div>
            </div>
            <div class="flex items-center gap-2">
                <a href="<?= route_to(
    ...
    <div id="alerts" class="top-0 absolute inset-x-0 flex flex-col items-center gap-4 p-4">{alerts}</div>
</body>
</html>
